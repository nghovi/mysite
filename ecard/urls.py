...
urlpatterns = [
    ...
    url(r'^task/id=(?P<pk>[0-9]+)/$',
        viewstask.TaskDetail.as_view(), name='get_task'),
    url(r'^tasks/$', viewstask.TaskList.as_view(), name='get_tasks'),
    url(r'^task_stats/$', viewstask.task_stats, name='task_stats'),
    ...
    url(r'^book/id=(?P<pk>[0-9]+)/$',
        viewsbook.BookDetail.as_view(), name='get_book_detail'),
    ...
    url(r'^word/id=(?P<pk>[0-9]+)/$',
        viewsbook.WordDetail.as_view(), name='get_word'),
    url(r'^add_word/$', viewsbook.add_word, name='add_word'),
    url(r'^phrases/$', viewsbook.PhraseList.as_view(), name='get_phrases'),
    url(r'^phrase/id=(?P<pk>[0-9]+)/$',
        viewsbook.PhraseDetail.as_view(), name='get_phrase'),
